      ...
      <div class="category-card category-card-${status}">
        <div class="category-card-header">
          ...
          <div class="category-card-actions">
            <button class="btn-icon btn-edit admin-only" onclick="openEditCategoryModal('${cat.name}')" title="Edit">✏️</button>
            <button class="btn-icon btn-delete admin-only" onclick="confirmDeleteCategory('${cat.name}')" title="Delete">🗑️</button>
          </div>
        </div>
