    ...
    <div class="goal-card ${statusCls}" data-id="${goal._id}">
      ...
      ${goal.status === 'active' ? `
        <div class="goal-card-actions">
          <button class="btn btn-sm btn-success" onclick="markAchieved('${goal._id}')">✅ Mark Achieved</button>
          <button class="btn btn-sm btn-outline"  onclick="openEditGoalModal('${goal._id}')">✏️ Edit</button>
          <button class="btn btn-sm btn-danger"   onclick="confirmDeleteGoal('${goal._id}')">🗑️ Delete</button>
        </div>
      ` : `
        <div class="goal-card-actions">
          <button class="btn btn-sm btn-outline" onclick="confirmDeleteGoal('${goal._id}')">🗑️ Delete</button>
        </div>
      `}
    </div>
  `;
